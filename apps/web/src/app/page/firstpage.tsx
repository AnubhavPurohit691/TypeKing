...
export default function Firstpage() {
  ...
  return (
    <main className="w-full mx-auto max-w-5xl text-white p-5">
      ...
      <Card className="p-5 mt-10 grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="p-5 flex flex-col justify-between">
          ...
          <div>
            <Button className="mt-5 w-full hover:text-white bg-white text-black" onClick={createGame}>
              Create Game
            </Button>
          </div>
        </div>
        ...
        <div className="p-5 flex flex-col justify-between">
          ...
          <div className="mt-5">
            <form onSubmit={joinGame}>
              ...
              <Button className="mt-3 w-full bg-white text-black hover:text-white">Join Game</Button>
            </form>
          </div>
        </div>
      </Card>
